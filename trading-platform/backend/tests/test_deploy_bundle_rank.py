...
def test_bundle_rank_prefers_newer_revisions():
  assert bundle_rank({"bundleRevision": "2026-08-29-r65", "features": {"activeGate": True}}) == 100
  assert bundle_rank({"bundleRevision": "2026-08-29-r65", "features": {"activeGate": True}}) > bundle_rank(
    {"bundleRevision": "2026-08-29-r64", "features": {"activeGate": True}}
  )
