...
def test_bundle_rank_prefers_newer_revisions():
  assert bundle_rank({"bundleRevision": "2026-08-28-r26", "features": {"activeGate": True}}) == 100
  assert bundle_rank({"bundleRevision": "2026-08-28-r26", "features": {"activeGate": True}}) > bundle_rank(
