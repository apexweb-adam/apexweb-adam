...
def test_bundle_rank_prefers_newer_revisions():
  assert bundle_rank({"bundleRevision": "2026-08-29-r82", "features": {"activeGate": True}}) == 100
  assert bundle_rank({"bundleRevision": "2026-08-29-r82", "features": {"activeGate": True}}) > bundle_rank(
    {"bundleRevision": "2026-08-29-r81", "features": {"activeGate": True}}
  )
